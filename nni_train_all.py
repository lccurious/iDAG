...
from domainbed.nni_trainer import train
...
def main(nni_params):
    ...
    logger.nofmt("NNI:")
    for k, v in sorted(nni_params.items()):
...
if __name__ == "__main__":
    tune_parameters = nni.get_next_parameter()
    main(tune_parameters)
